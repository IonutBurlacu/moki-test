          ...
          {this.props.challenge.type === 'player' ? (
            <div className="row">
              ...
              <span>
                ...
                {this.props.challenge.players.length > 1 ? 's' : ''}
              </span>
            </div>
          ) : (
            <div className="row">
              ...
              <span>
                ...
                {this.props.challenge.teams.length > 1 ? 's' : ''}
              </span>
            </div>
          )}
          <div className="row">
            <span>
              Created:{' '}
              {moment(this.props.challenge.created_at).format('DD/MM/YYYY')}
            </span>
          </div>
          <div className="row">
            <span>
              ...
              {this.props.challenge.last_sync_at === null
                ? 'Never'
                : moment(this.props.challenge.last_sync_at).format(
                    'DD/MM/YYYY'
                  )}
            </span>
          </div>
