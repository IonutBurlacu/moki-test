    ...
    return (
      <div className="page-header">
        <div className="col left">
          ...
          <div className="right-side">
            ...
            <span className="subtitle">
              Age {moment().diff(moment(this.props.player.birthday), 'year')},{' '}
              {this.props.player.gender === 'male' ? 'Boy' : 'Girl'}
            </span>
          </div>
        </div>
        ...
        <div className="col column right">
          <div className="row">
            <span>
              Born: {moment(this.props.player.birthday).format('DD/MM/YYYY')}
            </span>
          </div>
          <div className="row">
            <span>
              Created:{' '}
              {moment(this.props.player.created_at).format('DD/MM/YYYY')}
            </span>
          </div>
          <div className="row">
            <span>
