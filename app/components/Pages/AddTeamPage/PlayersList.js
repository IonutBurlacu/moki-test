...
import { detachNewTeamFromPlayer } from '../../../actions/teams';
...
export class PlayersList extends Component {
    ...
    detachFromPlayer = playerId => {
        this.props.detachNewTeamFromPlayer(playerId);
    };
...
const mapDispatchToProps = dispatch => ({
    detachNewTeamFromPlayer: playerId =>
        dispatch(detachNewTeamFromPlayer(playerId))
});
