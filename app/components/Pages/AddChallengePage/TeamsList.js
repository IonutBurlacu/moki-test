...
import { detachNewChallengeFromTeam } from '../../../actions/challenges';
...
export class TeamsList extends Component {
    ...
    detachFromTeam = teamId => {
        this.props.detachNewChallengeFromTeam(teamId);
    };
...
const mapDispatchToProps = dispatch => ({
    detachNewChallengeFromTeam: teamId =>
        dispatch(detachNewChallengeFromTeam(teamId))
});
